...
export default function ResultStep({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:py-12 lg:max-w-7xl min-[2400px]:max-w-[1800px]! min-[2400px]:py-20!">
      <div className="game-card p-6 sm:p-10 lg:grid lg:grid-cols-[1fr_360px] lg:items-start lg:gap-10 xl:grid-cols-[1fr_420px] min-[2400px]:p-20! min-[2400px]:gap-16!">
        <h2 className="text-center text-xl font-black text-rose-600 sm:text-2xl lg:col-span-2 min-[2400px]:text-7xl!">
          結果揭曉 / Ergebnis
        </h2>

        <div>
          {generatedImageDataUrl ? (
            <div className="relative mx-auto mt-6 aspect-square w-full max-w-sm overflow-hidden rounded-3xl shadow-lg ring-4 ring-rose-200 lg:h-[58vh] lg:w-auto lg:max-w-none min-[2400px]:mt-14! min-[2400px]:h-[60vh]! min-[2400px]:rounded-[2.5rem]! min-[2400px]:ring-8!">
            ...
            <div className="mx-auto mt-6 flex aspect-square w-full max-w-sm flex-col items-center justify-center gap-4 rounded-3xl bg-rose-50 p-10 text-center ring-4 ring-rose-100 lg:h-[58vh] lg:w-auto lg:max-w-none min-[2400px]:mt-14! min-[2400px]:h-[60vh]! min-[2400px]:rounded-[2.5rem]! min-[2400px]:gap-8! min-[2400px]:ring-8!">
          ...
          {!isGenerating && revealed && (
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 min-[2400px]:mt-14! min-[2400px]:gap-12!">
              <div className="text-center">
                ...
                <div className="aspect-square overflow-hidden rounded-2xl ring-4 ring-rose-200 lg:h-[42vh] lg:w-auto min-[2400px]:h-[44vh]! min-[2400px]:rounded-3xl! min-[2400px]:ring-8!">
                  {generatedImageDataUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img src={generatedImageDataUrl} alt="AI 生成的新娘" className="h-full w-full object-cover" />
                  ) : (
                    <div className="flex h-full items-center justify-center bg-rose-50 text-sm text-foreground/50 min-[2400px]:text-2xl!">
                      無圖片 / Kein Bild
                    </div>
                  )}
                </div>
        ...
        <div className="mt-10 lg:mt-6 min-[2400px]:mt-14!">
          <h3 className="text-center text-lg font-black text-rose-600 sm:text-xl lg:text-left min-[2400px]:text-5xl!">
          ...
          <p className="mt-6 text-center text-2xl font-black text-gold-500 lg:text-left min-[2400px]:mt-12! min-[2400px]:text-8xl!">
            {total} / 25
          </p>
          <p className="mt-2 text-center text-sm font-semibold text-rose-600 sm:text-base lg:text-left min-[2400px]:mt-6! min-[2400px]:text-4xl!">
            {summary.zh}
          </p>
          <p className="text-center text-xs text-foreground/60 sm:text-sm lg:text-left min-[2400px]:text-2xl!">
            {summary.de}
          </p>

          <div className="mt-10 flex flex-col justify-center gap-3 lg:justify-start min-[2400px]:mt-20! min-[2400px]:gap-8!">
